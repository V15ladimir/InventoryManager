        ...
        private async Task SeedInventoriesAsync() {
            ...
            var privateInventory = new Inventory {
                ...
                Fields = new List<Field> {
                    new SinglelineField { 
                        Name = "Document Name", 
                        FieldState = FieldState.NotPresent, 
                        Order = 1
                    },
                    new SinglelineField { 
                        Name = "Employee Name", 
        ...
        private async Task SeedItemsForEquipmentInventory(int inventoryId, string createdBy) {
            var items = new[] {
                new { 
                    ...
                    Location = "Office A", 
                    IsWorking = true, 
                    Documentation = "https://www.dell.com/support/manuals/xps-15-7590-laptop/xps-15-7590-service-manual"
                },
                new { 
                    ...
                    Location = "Office B", 
                    IsWorking = true, 
                    Documentation = "https://support.hp.com/in-en/product/setup-user-guides/hp-laserjet-pro-4001-4004ne-dne-dwe-hp-printer-series/model/35911591"
                },
                new { 
                    ...
                    Location = "Office A", 
                    IsWorking = false, 
                    Documentation = "https://support.logi.com/hc/en-ca/articles/360023262774-Set-MX-Master-mouse-sensitivity-and-pointer-speed-with-Logitech-Options"
                }
            };
            var inventory = await context.Inventories.FirstOrDefaultAsync(x => x.Id == inventoryId) ??
                throw new NotFoundException("Inventory not found");
            var fieldsList = inventory.Fields.OrderBy(f => f.Order).ToList();
            var sequence = 0;

            foreach(var itemData in items) {
                sequence++;
                var customId = $"EQ-{sequence:D4}-{DateTime.UtcNow:yyyy}";
                var values = new List<ItemValue> {
                    new() { 
                    ...
                    new() { 
                        FieldId = fieldsList[2].Id, 
                        Value = itemData.Price.ToString()
                    },
                    new() { 
                        FieldId = fieldsList[3].Id, 
                        Value = itemData.Location
                    },
                    new() { 
                        FieldId = fieldsList[4].Id, 
                        Value = itemData.IsWorking.ToString().ToLower()
                    },
                    new() { 
                        FieldId = fieldsList[5].Id, 
                        Value = itemData.Documentation
                    }
                };
                var item = new Item {
        ...
        private async Task SeedItemsForBookInventory(int inventoryId, string createdBy) {
            ...
            foreach(var itemData in items) {
                ...
                var values = new List<ItemValue> {
                    ...
                    new() { 
                        FieldId = fieldsList[4].Id, 
                        Value = itemData.Available.ToString().ToLower()
                    },
                    new() { 
                        FieldId = fieldsList[5].Id, 
                        Value = string.Empty
        ...
        private async Task SeedItemsForPrivateInventory(int inventoryId, string createdBy) {
            var items = new[] {
                new { 
                    ...
                    FileLink = "https://samplefile.com/samples/download/document/pdf/pdf_sample_file_500KB.pdf",
                    Approved = true
                },
                new { 
                    Name = "NDA Agreement", 
            ...
            foreach(var itemData in items) {
                ...
                var values = new List<ItemValue> {
                    ...
                    new() { 
                        FieldId = fieldsList[3].Id, 
                        Value = itemData.FileLink 
                    },
                    new() { 
                        FieldId = fieldsList[4].Id, 
                        Value = itemData.Approved.ToString().ToLower()
                    }
                };
                var item = new Item {
                    InventoryId = inventoryId,
